...
class Course(models.Model):
    ...
    course_fee = models.IntegerField(default=19600)
...
class CourseAnnouncement(models.Model):
    ...
    def __str__(self):
        return f"{self.posted_by.faculty_initial} -> Announcement {self.course}"
...
class ClassRoutine(models.Model):
    ...
    def __str__(self):
        return f"{self.day} - {self.start_time} to {self.end_time} -{self.course.course_id}"
...
class Payslip(models.Model):
    ...
    def __str__(self) -> str:
        return f"{self.student.user.first_name} {self.student.user.last_name}'s Payslip"